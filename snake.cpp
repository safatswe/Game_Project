...
int main(int argc, char* argv[]) {
    ...
    while (true) {
        ...
        if (x < 0 || x > scale * wScale -scale )
          {  x = 0;}
          if (y < 0 || y > scale * wScale -scale )
          y=0;
        ...
        // Draw "EX" in the window
        SDL_SetRenderDrawColor(renderer, 0,0 , 255, 255);

        // Draw "E"
        SDL_RenderDrawLine(renderer, 50, 50, 50, 150);  // Vertical
        SDL_RenderDrawLine(renderer, 50, 50, 100, 50);  // Top
        SDL_RenderDrawLine(renderer, 50, 100, 100, 100); // Middle
        SDL_RenderDrawLine(renderer, 50, 150, 100, 150); // Bottom

        // Draw "X"
        SDL_RenderDrawLine(renderer, 110, 50, 160, 150); // Diagonal
        SDL_RenderDrawLine(renderer, 110, 150, 160, 50); // Diagonal
